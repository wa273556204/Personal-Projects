    ...
    public ControlPanel(final NoteIndices notes, final ArrayPanel panel) {
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ArrayList<SortEvent<Integer>> compareEventList = new ArrayList<>();
                for(int i = 0; i < notes.getNotes().size() - 1; i++) {
                	compareEventList.add(new CompareEvent<Integer>(i, i + 1));
                }
                
                @SuppressWarnings("unchecked")
                ArrayList<Integer> tempNotes = (ArrayList<Integer>) notes.getNotes().clone();
                final List<SortEvent<Integer>> events = generateEvents((String)sorts.getSelectedItem(), tempNotes);
                events.addAll(compareEventList);
